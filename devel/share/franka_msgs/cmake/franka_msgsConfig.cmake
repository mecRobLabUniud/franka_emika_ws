...
if(NOT "/home/panda/franka_emika_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/panda/franka_emika_ws/src/franka_ros/franka_msgs/${idir}'.  ${_report}")
    endif()
