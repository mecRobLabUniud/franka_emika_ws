...
(cl:defmethod cl:initialize-instance :after ((m <CalcValidTraj-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalcValidTraj-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name def_proj-srv:<CalcValidTraj-request> is deprecated: use def_proj-srv:CalcValidTraj-request instead.")))

(cl:ensure-generic-function 'q_s-val :lambda-list '(m))
(cl:defmethod q_s-val ((m <CalcValidTraj-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:q_s-val is deprecated.  Use def_proj-srv:q_s instead.")
  (q_s m))

(cl:ensure-generic-function 'q_e-val :lambda-list '(m))
(cl:defmethod q_e-val ((m <CalcValidTraj-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:q_e-val is deprecated.  Use def_proj-srv:q_e instead.")
  (q_e m))

(cl:ensure-generic-function 'traj_duration-val :lambda-list '(m))
(cl:defmethod traj_duration-val ((m <CalcValidTraj-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:traj_duration-val is deprecated.  Use def_proj-srv:traj_duration instead.")
  (traj_duration m))

(cl:ensure-generic-function 'traj_step-val :lambda-list '(m))
(cl:defmethod traj_step-val ((m <CalcValidTraj-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:traj_step-val is deprecated.  Use def_proj-srv:traj_step instead.")
  (traj_step m))
...
(cl:defmethod cl:initialize-instance :after ((m <CalcValidTraj-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalcValidTraj-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name def_proj-srv:<CalcValidTraj-response> is deprecated: use def_proj-srv:CalcValidTraj-response instead.")))

(cl:ensure-generic-function 'flag_valid-val :lambda-list '(m))
(cl:defmethod flag_valid-val ((m <CalcValidTraj-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:flag_valid-val is deprecated.  Use def_proj-srv:flag_valid instead.")
  (flag_valid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalcValidTraj-response>)))
  ...
  "def_proj/CalcValidTrajResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalcValidTraj-response)))
  "Returns string type for a service object of type 'CalcValidTraj-response"
  "def_proj/CalcValidTrajResponse")
