...
(cl:defmethod cl:initialize-instance :after ((m <FlagStop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlagStop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name def_proj-srv:<FlagStop-request> is deprecated: use def_proj-srv:FlagStop-request instead.")))

(cl:ensure-generic-function 'T_stop-val :lambda-list '(m))
(cl:defmethod T_stop-val ((m <FlagStop-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:T_stop-val is deprecated.  Use def_proj-srv:T_stop instead.")
  (T_stop m))
...
(cl:defmethod cl:initialize-instance :after ((m <FlagStop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlagStop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name def_proj-srv:<FlagStop-response> is deprecated: use def_proj-srv:FlagStop-response instead.")))

(cl:ensure-generic-function 'flag_stop-val :lambda-list '(m))
(cl:defmethod flag_stop-val ((m <FlagStop-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj-srv:flag_stop-val is deprecated.  Use def_proj-srv:flag_stop instead.")
  (flag_stop m))
