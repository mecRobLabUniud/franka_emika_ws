...
(cl:defmethod cl:initialize-instance :after ((m <FlagStop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlagStop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name def_proj_Panda-srv:<FlagStop-request> is deprecated: use def_proj_Panda-srv:FlagStop-request instead.")))

(cl:ensure-generic-function 'T_stop-val :lambda-list '(m))
(cl:defmethod T_stop-val ((m <FlagStop-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj_Panda-srv:T_stop-val is deprecated.  Use def_proj_Panda-srv:T_stop instead.")
  (T_stop m))

(cl:ensure-generic-function 'q-val :lambda-list '(m))
(cl:defmethod q-val ((m <FlagStop-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj_Panda-srv:q-val is deprecated.  Use def_proj_Panda-srv:q instead.")
  (q m))

(cl:ensure-generic-function 'q_p-val :lambda-list '(m))
(cl:defmethod q_p-val ((m <FlagStop-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj_Panda-srv:q_p-val is deprecated.  Use def_proj_Panda-srv:q_p instead.")
  (q_p m))

(cl:ensure-generic-function 'q_pp-val :lambda-list '(m))
(cl:defmethod q_pp-val ((m <FlagStop-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj_Panda-srv:q_pp-val is deprecated.  Use def_proj_Panda-srv:q_pp instead.")
  (q_pp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FlagStop-request>)))
  ...
  "def_proj_Panda/FlagStopRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FlagStop-request)))
  "Returns string type for a service object of type 'FlagStop-request"
  "def_proj_Panda/FlagStopRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FlagStop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlagStop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name def_proj_Panda-srv:<FlagStop-response> is deprecated: use def_proj_Panda-srv:FlagStop-response instead.")))

(cl:ensure-generic-function 'flag_stop-val :lambda-list '(m))
(cl:defmethod flag_stop-val ((m <FlagStop-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader def_proj_Panda-srv:flag_stop-val is deprecated.  Use def_proj_Panda-srv:flag_stop instead.")
  (flag_stop m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FlagStop-response>)))
  ...
  "def_proj_Panda/FlagStopResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FlagStop-response)))
  "Returns string type for a service object of type 'FlagStop-response"
  "def_proj_Panda/FlagStopResponse")
