...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_example_controllers;/usr/lib/libfranka.so.0.8.0".split(';') if "-lfranka_example_controllers;/usr/lib/libfranka.so.0.8.0" != "" else []
